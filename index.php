...
<body class="skin-container" topmargin="0" oncontextmenu="return false" ondragstart="return false" onselectstart="return false" onselect="document.getSelection().empty()" oncopy="document.getSelection().empty()" onbeforecopy="return false">
    ...
    <div class="list closed">
        <ul>
            ...
            <li><a rel="nofollow" href="//retrocode.io/" target="_blank"><i class="iconfont icon-boke-copy"></i>我的博客</a></li>
            <li><a rel="nofollow" href="//github.com/" target="_blank"><i class="iconfont icon-git"></i>Github</a></li>
            <li><a rel="nofollow" href="//gitee.com/" target="_blank"><i class="iconfont icon-mayun" style="color:#f03;"></i>码云</a></li>
            <li><a rel="nofollow" href="//juejin.im/" target="_blank"><i class="iconfont icon-juejin" style="color: #0084ff;"></i>掘金</a></li>
            <li><a rel="nofollow" href="//www.ituring.com.cn/" target="_blank"><i class="iconfont icon-tulingdianzika" style="color: #0084ff;"></i>图灵社区</a></li>
            <li><a rel="nofollow" href="//uniapp.dcloud.io/" target="_blank"><i class="iconfont icon-uni-app" style="color: green;"></i>Uni-App</a></li>
            <li><a rel="nofollow" href="//www.apicloud.com/" target="_blank"><i class="iconfont icon-APICloud" style="color: #0084ff;"></i>ApiCloud</a></li>
            <li><a rel="nofollow" href="//taro.aotu.io/" target="_blank"><i class="iconfont icon-React" style="color: #0084ff;"></i>Taro</a></li>
            ...
            <li><a rel="nofollow" href="//tieba.baidu.com/f?kw=steam" target="_blank"><i class="iconfont icon-tieba1"></i>Steam吧</a></li>
            <!------>
            <li class="title"><i class="iconfont icon-xingzhuang"></i> 邮箱</li>
            <li><a rel="nofollow" href="//mail.qq.com/" target="_blank"><i class="iconfont icon-QQyouxiang" style="color: #f05;"></i>QQ邮箱</a></li>
            <!------>
            <li class="title"><i class="iconfont icon-xiaoxi"></i> 社交</li>
            <li><a rel="nofollow" href="//www.zhihu.com/" target="_blank"><i class="iconfont icon-zhihu" style="color: #0084ff;"></i>知乎</a></li>
            <li><a rel="nofollow" href="//www.gamersky.com/" target="_blank"><i class="iconfont icon-youminxingkong" style="color:#f03;"></i>游民星空</a></li>
            <li><a rel="nofollow" href="//www.ltaaa.com/" target="_blank"><i class="iconfont icon-long" style="color:#0084ff;"></i>龙腾网</a></li>
            <!------>
            ...
            <li><a rel="nofollow" href="//www.taobao.com" target="_blank"><i class="iconfont icon-taobao" style="color: #ff6019;"></i>淘宝网</a></li>
            <li><a rel="nofollow" href="//www.jd.com" target="_blank"><i class="iconfont icon-jingdong" style="color: #e33333;"></i>京东</a></li>
            <!------>
            <li class="title"><i class="iconfont icon-sheji"></i> 设计视觉</li>
            <li><a rel="nofollow" href="//www.iconfont.cn/" target="_blank"><i class="iconfont icon-print" style="color: #ff6019;"></i>阿里图标</a></li>
            <!------>
